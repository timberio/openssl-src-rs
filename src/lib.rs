...
impl Build {
    ...
    pub fn build(&mut self) -> Artifacts {
        ...
        let os = match target {
            ...
            "armv7-linux-androideabi" => "linux-generic32",
            "arm-unknown-linux-gnueabi" => "linux-generic32",
            "arm-unknown-linux-gnueabihf" => "linux-generic32",
            "arm-unknown-linux-musleabi" => "linux-generic32",
            "arm-unknown-linux-musleabihf" => "linux-generic32",
            "armv7-unknown-linux-gnueabihf" => "linux-generic32",
            "armv7-unknown-linux-musleabihf" => "linux-generic32",
